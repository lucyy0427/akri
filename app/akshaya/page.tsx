...
export default function AkshayaPage() {
  ...
  useEffect(() => {
    async function loadData() {
      ...
      if (!profile || profile.person !== "akshaya") {
        setProfileError(
          "This account is not connected to the Akshaya profile.",
        );
        setLoading(false);
        return;
      }
  ...
  return (
    <main className="min-h-screen bg-[#f5f5f0] p-5 pb-24 text-[#252525] md:p-10 md:pb-10">
      <div className="mx-auto max-w-5xl">
        ...
        {/* Header */}
        <div className="mb-8">
          <p className="text-sm text-[#888]">Personal tracker</p>
              ...
              <label className="block text-sm text-[#666]">
                ...
                <div className="mt-2 flex items-center gap-2">
                  <input
                    ...
                    onChange={(e) =>
                      updateField("work_minutes", e.target.value)
                    }
          ...
          <section className="rounded-3xl border border-black/5 bg-white p-6 shadow-sm md:col-span-2">
            ...
            <label className="mt-5 flex cursor-pointer items-center gap-3">
              <input
                ...
                onChange={(e) =>
                  updateField("workout_done", e.target.checked)
                }
            ...
            <textarea
              ...
              onChange={(e) =>
                updateField("workout_notes", e.target.value)
              }
              rows={4}
